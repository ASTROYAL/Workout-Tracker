  ...
  'push-a': RoutineModel(
    ...
    exercises: [
      RoutineExerciseModel(
        ...
        badge: 'Compound',
        setup: ['Eyes directly under the bar', 'Grip slightly wider than shoulders', 'Pinch shoulder blades together and down', 'Feet flat on the floor, drive through heels', 'Small natural arch in lower back'],
        execution: ['Lower slowly (3s) to your lower chest', 'Touch chest lightly — don\'t bounce', 'Press up and slightly back toward rack', 'Lock out elbows at top, squeeze chest'],
        mistakes: ['✓ Chest stretch at bottom, squeeze at top', '✗ Don\'t flare elbows 90° — keep 45–75°', '✗ Don\'t bounce bar off chest', '✗ Don\'t lift your butt off bench'],
      ),
      RoutineExerciseModel(
        ...
        badge: 'Compound',
        setup: ['Feet shoulder-width, grip just outside shoulders', 'Bar rests on upper chest / front delts', 'Brace core like you expect a punch', 'Squeeze glutes — keeps lower back safe'],
        execution: ['Press straight up — vertical bar path', 'Move head back slightly as bar passes face', 'Lock out arms fully, shrug traps up at top', 'Lower slowly and repeat'],
        mistakes: ['✓ Front delts firing, core staying tight', '✗ Don\'t lean back excessively', '✗ Don\'t press forward — go straight up', '✗ Don\'t use leg drive'],
      ),
      RoutineExerciseModel(
